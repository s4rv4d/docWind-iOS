//
//  EditPdfSubView.swift
//  docWind
//
//  Created by Sarvad shetty on 8/11/20.
...
struct EditPdfSubView: View {
    ...
    // MARK: - Init
    init(pdfName: String, selectedIconName: String, mainPages: [UIImage], url: String, pdfEditted: Binding<String>) {
...
//                    .disabled(!AppSettings.shared.bougthNonConsumable)
    ...
    private func saveTapped() {
        ...
        if (self.pages.count == 0 || self.pagesWithMark.count == 0) {
            ...
            self.pdfEditted.wrappedValue = url
